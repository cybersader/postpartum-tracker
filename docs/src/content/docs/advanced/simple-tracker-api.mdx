...
Users enable trackers in Settings > Tracker Library. The module ID is added to `settings.enabledModules[]`. A plugin reload is required for the change to take effect.
