...
| **Notes & comments** | Free-text timestamped notes with categories (general, concern, milestone, reminder). Acts as catch-all for [quick entry](/postpartum-tracker/guides/quick-entry/) |
...
Hold-for-details is configurable per tracker type. See [Customization](/postpartum-tracker/guides/customization/) for details.
